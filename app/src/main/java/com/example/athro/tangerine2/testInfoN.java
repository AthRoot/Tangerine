...
public class testInfoN  extends Activity implements View.OnClickListener {
    EditText texts0;
    EditText texts1;
    EditText texts2;
    EditText texts3;
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.button23) {
            ...
            testInfoN.Background1 bc = new testInfoN.Background1(context);
            //bc.execute("testId");
            bc.execute("creatText","1",ary0,ary1,ary2,ary3,ary4,ary5,ary6,ary7,ary8);
    ...
    public void testIdm (int id , int j){
        ...
        if(j ==1){
            ...
            testInfoN.Background2 bc = new testInfoN.Background2(context);
    ...
    public class Background1 extends AsyncTask<String ,Void , String> {
        ...
        protected String doInBackground(String... params) {
            String type = params[0];
                ...
                String login_url = ur+"/insertTesti.php";
                try {
                    ...
                    String post_data =URLEncoder.encode("id  ","UTF-8") +  "=" + URLEncoder.encode("1"  ,  "UTF-8")+ "&"
